...
if __name__ == '__main__':
    ...
    command['collect'] = \
              f"python collect.py {sample} {sample_path} {log_path} {generate_location} {bed_key} {sample_monitor}"
    command['collect_Custom'] = \
              f"python collect_Custom.py {sample} {sample_path} {log_path} {generate_location} {bed_key} {collect_list_str} {collect_Alternative_items} {sample_monitor}"     
    # 流程list
