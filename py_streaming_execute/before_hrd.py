...
if __name__ == '__main__':
    ...
    def choose_bed(panel: str) -> str:  
        options = {
            ...
            'HRR':'/refhub/hg19/target/HRR/HRR_CapCovered.bed'
        }
    ...
    elif bed_key in ['HRD','HRR']:
        collect_list = ['meta','somatic','germline','fusion','cnv','hrd','qc']
    ...
    # 流程list
    execution_order_list = ['TN_similarity_qc','fastp_extract','extract_qc','bwa_mapping','picard_markdup','dedup_markdup_pc']
