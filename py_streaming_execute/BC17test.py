...
if __name__ == '__main__':
    ...
    bed = '/refhub/hg19/target/BC17T/BC17.expand1.hg19.bed'
    bed_key = 'BC17T'
    ...
    command['split_callMutation_merge'] = \
              ...
              conda deactivate"
    command['split_callMutation_merge_test'] = \
              f"source /opt/miniconda3/etc/profile.d/conda.sh  && \
              conda activate call_mutation_fbs && \
              python split_callMutation_merge_test.py {sample} {sample_path} {log_path} {generate_location} {ref_fasta} && \
              conda deactivate"
    ...
    # 流程list
    execution_order_list = ['pollution_filter','annovar','process_anno_filter','panelcn_map_bam','factera','collect']# ['fastp_extract','extract_qc','bwa_mapping','picard_markdup','dedup_markdup_pc','split_callMutation_merge','pollution_filter','annovar','process_anno_filter','panelcn_map_bam','factera','collect']
