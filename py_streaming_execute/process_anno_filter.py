...
def process_anno_filter():
    ...
    df_retain['RNA'],df_retain['EXON'],df_retain['NCchange'],df_retain['AAchange'] = None, None, None,None
    if not df_retain[df_retain['AAChange.smallrefGene'] != '.'].empty:
        df_retain['RNA'] = \
...
def reserved_noexonic_vaf_greater_than_3():
    process_anno_filter_txt = annover_txt.replace('anno', 'process')
...
if __name__ == '__main__':
    anno_filter()
    process_anno_filter()
    reserved_noexonic_vaf_greater_than_3()
