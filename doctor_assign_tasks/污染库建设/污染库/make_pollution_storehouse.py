...
class data():
    def __init__(self):
        ...
        # num_list = ['0755T', '0757T', '0970T', '4418T', '5243T', '5259T', '5261T', '5589T']  Q120
        ...
        for num in num_list:
            ...
            exec(f"df_{num}=df_{num}[['Chr','Start','CLNSIG_{num}','VAF_{num}']]")
            self.df_list.append(locals()[f'df_{num}'])
    ...
    def group_compress_position(self,input_file='pollution_storehouse.txt'):
        ...
        inner_list = ['Chr','Start']
        add_VAF_behand_num_list = list(map(lambda x: 'VAF_' + x, self.num_list))
        inner_list.extend(add_VAF_behand_num_list)     # ['Chr', 'Start', 'VAF_1537', 'VAF_1567', 'VAF_1568', 'VAF_1596', 'VAF_1597', 'VAF_3292', 'VAF_3294', 'VAF_3295', 'VAF_4409']
        df_result = df_result[inner_list]
        print(df_result)
