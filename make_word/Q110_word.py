    ...
    def format_Table(self, doc,table_index=-1, header_size=10,First_column_colore=True,col_width=[1, 1], header_color=RGBColor(0, 0, 0), Border=[],
        ...
        for i, row in enumerate(table.rows):
            ...
            for index,cell in enumerate(cells):
                ...
                if cell.paragraphs[0].text == '未检出相关基因突变' \
                        or cell.paragraphs[0].text == '未检出相关基因突变，无相关提示。'\
                        or cell.paragraphs[0].text == '未检到已知的 DNA 错配修复基因致病性/可能致病性位点':
...
class Q110():
    def __init__(self, input_file):
        self.doc = Document('/refhub/ref/masterplate/解码110基因报告母版.2023v1的副本.docx')
