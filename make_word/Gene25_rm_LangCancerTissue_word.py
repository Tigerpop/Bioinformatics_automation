...
class Q80():
    def __init__(self, input_file):
        self.doc = Document('/refhub/ref/masterplate/25基因检测报告_睿明医学_组织版_肺癌.docx')
    ...
    @Tools_Decorator(tool='format_Cell', table_index=-5,position=position, size=10, color=RGBColor(0, 0, 0))
    ...
    def add_header(self, manual_Date=None):  # 改页眉。
        ...
        even_page_header.tables[0].cell(0, 0).paragraphs[0].runs[0].font.color.rgb = RGBColor(47, 83, 149)
        header.tables[0].cell(0, 1).paragraphs[0].runs[0].font.color.rgb = RGBColor(47, 83, 149)
        return self.doc
